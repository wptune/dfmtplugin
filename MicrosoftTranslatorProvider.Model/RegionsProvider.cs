...
public class RegionsProvider
{
	...
	{
		return new List<RegionSubscription>
		{
			...
			new RegionSubscription
			{
				Key = "unitedstateseuap",
				Name = "United States EUAP",
				Location = "United States EUAP"
			},
			new RegionSubscription
			{
				Key = "westcentralus",
			...
			new RegionSubscription
			{
				...
				Location = "East US 2 (Stage)"
			},
			new RegionSubscription
			{
				Key = "eastusstage",
				Name = "East US (Stage)",
				Location = "East US (Stage)"
			},
			new RegionSubscription
			{
				Key = "northcentralusstage",
				Name = "North Central US (Stage)",
				Location = "North Central US (Stage)"
			},
			new RegionSubscription
			{
				Key = "southcentralusstage",
				Name = "South Central US (Stage)",
				Location = "South Central US (Stage)"
			},
			new RegionSubscription
			{
				Key = "southeastasiastage",
				Name = "Southeast Asia (Stage)",
				Location = "Southeast Asia (Stage)"
			},
			new RegionSubscription
			{
				Key = "westus2stage",
				Name = "West US 2 (Stage)",
				Location = "West US 2 (Stage)"
			},
			new RegionSubscription
			{
				Key = "westusstage",
				Name = "West US (Stage)",
				Location = "West US (Stage)"
			}
		};
	}
}
